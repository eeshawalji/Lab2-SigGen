...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgSData(oldp+7,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count) 
                                      - (IData)(vlSelf->offset)))),9);
    bufp->chgSData(oldp+8,(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count),9);
    bufp->chgCData(oldp+9,(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count),8);
}
