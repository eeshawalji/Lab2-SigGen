...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vdly__sigdelay__DOT____Vcellout__addrCounter__count 
        = vlSelf->sigdelay__DOT____Vcellout__addrCounter__count;
    if (vlSelf->rst) {
        vlSelf->__Vdly__sigdelay__DOT____Vcellout__addrCounter__count = 0U;
    } else if (vlSelf->wr) {
        vlSelf->__Vdly__sigdelay__DOT____Vcellout__addrCounter__count 
            = (0xffU & ((IData)(1U) + (IData)(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count)));
    }
}
