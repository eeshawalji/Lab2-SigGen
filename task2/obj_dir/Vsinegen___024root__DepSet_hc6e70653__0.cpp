...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vdly__sinegen__DOT__addr1 = vlSelf->sinegen__DOT__addr1;
    if (vlSelf->rst) {
        vlSelf->__Vdly__sinegen__DOT__addr1 = 0U;
    } else if (vlSelf->en) {
        vlSelf->__Vdly__sinegen__DOT__addr1 = (0xffU 
                                               & ((IData)(1U) 
...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__2(Vsinegen___024root* vlSelf) {
    ...
    // Body
    vlSelf->sinegen__DOT__addr1 = vlSelf->__Vdly__sinegen__DOT__addr1;
}
